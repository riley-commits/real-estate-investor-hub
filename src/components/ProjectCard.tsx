...
const ProjectCard = ({ project }: ProjectCardProps) => {
  ...
  return (
    <Link
      ...
      className="group block overflow-hidden rounded-xl border border-border bg-card transition-all duration-300 hover:border-gold/40 hover:shadow-gold hover:-translate-y-1"
    >
      {/* Image */}
      ...
      {/* Content */}
      <div className="p-5">
        <h3 className="font-display mb-1 text-lg font-semibold text-foreground group-hover:text-gold transition-colors line-clamp-1">
          {project.name}
        </h3>
